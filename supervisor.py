"""
stockexchange_V0.5 — Supervisor (NYSE-Aware Scheduler)
...
def main(dry_run: bool = False):
    log.info("=" * 60)
    log.info("stockexchange_V0.5 Supervisor — Starting")
    check_db_integrity()
    ...
    if not dry_run:
        try:
            ...
            telegram_bot.send_emergency_alert(
                f"🚀 stockexchange_V0.5 supervisor started on Pi\n"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="stockexchange_V0.5 Supervisor")
